...
- **Enhancing Collaborative Neuroimaging Research: Introducing COINSTAC Vaults for Federated Analysis and Reproducibility** — _Frontiers in Neuroinformatics_ (Jun 2023): Co-authored peer-reviewed paper demonstrating federated analysis capabilities that improve reproducibility and increase sample sizes in neuroimaging studies without requiring data sharing.
