...
**Principal AI Engineer & Architect** | Indianapolis, IN | paul@example.com | linkedin.com/in/paulprae | github.com/praeducer | paulprae.com

---

## Professional Summary

AI engineering leader with 10+ years building production AI systems for healthcare, life sciences, and financial services. Deep expertise in healthcare domain (Arine, BCBS, Humana ecosystem) with enterprise delivery at AWS, Microsoft, and Slalom. Combines full-stack technical depth across data engineering, ML systems, and cloud infrastructure with engineering leadership to drive measurable business impact.
